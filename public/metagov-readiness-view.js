...
const messages={
 ...
 'record-uuid':['來源 ID 不是 UUID；需要可回查的對照表。','Source IDs are not UUIDs; a reversible ID map is needed.'],
 generator:['缺少已核對的 Generator；暱稱、工具名與檢查者不能代替產生者。','Verified Generator missing; aliases, tool names and reviewers do not identify the creator.'],
