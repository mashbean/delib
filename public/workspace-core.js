import {validateOperations} from './operations-core.js';
...
export function validateProject(p) {
  ...
  validateOperations(p);validateSettings(p);validateMetagovMappings(p);validateFacilitation(p);validateTransfers(p);validateNativeImports(p);
