...
await build({entryPoints:['public/workspace-flow-scene.js'],outfile:'public/vendor/workspace-flow.bundle.js',bundle:true,minify:true,format:'esm',target:['es2022'],legalComments:'linked'});
