...
| 5 | Ethelo + Stanford PB | **Pocket Budget**: cost-constrained multi-option voting with support and inequality scores | Both are "decide" tools; Ethelo ships only an engine and Stanford PB is a Rails site. One small tool covers both. | done 2026-09-06 (budget.mashbean.net; knapsack/approval ballots, most-voted bundle + fairness-adjusted bundle; no model calls) |
