...
**0.5 更新：** 本文的 8／4、5／7、7／5 為原版整輪名義模式；新版依 `attendance.phaseModes` 記錄每一步的線上／實體出席，人物會換場。來源主題也經人工逐句重校。以 [第二輪改版紀錄](iteration-two-2026-09-06.md) 與目前 fixture 為準。
以下以本機程式碼及本機解析測試為證據；不是對每個公開服務的端到端驗收。
